      ...
      >
        ...
        >
          ...
          <div style={{ flex: "1 1 380px" }}>
            ...
            >
              {["Fast Shipping", "Quality Tested", "Secure Checkout"].map(
                (badge) => (
                  <span
                    key={badge}
                    className="counter"
          ...
          >
            ...
            >
              <h3
                style={{ fontSize: "var(--font-lg)", marginBottom: "0.5rem" }}
              >
                Why Athletes Choose NutraSurge
              </h3>

              <div style={{ display: "grid", gap: "0.75rem", marginTop: "0.5rem" }}>
                {["Clinically Tested", "High Quality Ingredients", "Trusted by 10K+ Customers"].map(
                  (t) => (
                    <div
                      key={t}
                      style={{
                    ...
                    >
                      ...
                      <span style={{ fontSize: "var(--font-sm)" }}>{t}</span>
                    </div>
                  )
                )}
              </div>
            ...
            >
              ...
              <div
                style={{ fontSize: "0.82rem", color: "#555", lineHeight: 1.5 }}
              >
